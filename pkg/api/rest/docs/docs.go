...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/workflow/{wfId}/workflowRun/{wfRunId}/task_group_range": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Task groups to re-run",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_cloud-barista_cm-cicada_pkg_api_rest_model.TaskGroupRerunOption"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully cleared the task groups.",
                        "schema": {
                            "$ref": "#/definitions/github_com_cloud-barista_cm-cicada_pkg_api_rest_model.TaskInstanceReference"
                        }
                    },
                    ...
                    "500": {
                        "description": "Failed to clear the task groups.",
                        "schema": {
                            "$ref": "#/definitions/github_com_cloud-barista_cm-cicada_pkg_api_rest_common.ErrorResponse"
                        }
                    }
    ...
    "definitions": {
        ...
        "github_com_cloud-barista_cm-cicada_pkg_api_rest_model.TaskGroupRerunOption": {
            "type": "object",
            "properties": {
                "dryRun": {
                    "type": "boolean"
